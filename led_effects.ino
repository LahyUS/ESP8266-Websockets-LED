uint8_t idex = 0; // index of the current pixel
uint8_t ihue = 0; // color tone
uint8_t saturationVal = 255; // saturation value 
uint8_t ibright = 0; // brightness value
uint16_t TOP_INDEX = uint8_t(LED_COUNT / 2); // middle index
uint8_t EVENODD = LED_COUNT % 2; // parity check flag
...
// green ones run in circles randomly
void matrix(){
...
// locomotive running in a circle
